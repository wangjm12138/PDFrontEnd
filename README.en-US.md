...
## Introduce
The PD project is developed based on the streamlined version of the vue-pure-admin framework, mainly to demonstrate the analysis and display of Jabra project data.

The entire PD project consists of three parts:

- Data collection uses python script data to obtain Jira and Jama data
- Data analysis and display, front-end display is based on Vue-pure-admin
- Data processing and storage, the backend is based on Java Spring Alibaba Cloud microservice architecture

The specific project framework diagram is still being prepared...
...
- pnpm version >9
- node version >20，recommened 20.15.0 LTS
